package com.fs.common.database.configuration;

import com.fs.common.database.datasource.DynamicRoutingDataSource;
import com.fs.common.database.properties.ReplicationDataSourceProperties;
...
@ComponentScan(
        basePackages = {
                "com.fs.common.database",
                "com.fs.spring",
        }
)
@MapperScan(basePackages = "com.fs.domain")
